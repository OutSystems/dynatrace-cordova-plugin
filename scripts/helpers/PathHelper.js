...
var getAndroidAssetsPath = function () {
    if (isCapacitorApp()) {
        return getAndroidAssetsPathCapacitor();
    }
    else {
...
var getAndroidAssetsPathCapacitor = function () { return (0, path_1.join)(getAndroidPathCapacitor(), FOLDER_ANDROID_APP, 'src', 'main', exports.FOLDER_ASSETS, 'public'); };
